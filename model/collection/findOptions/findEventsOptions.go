 ...
 * @return r   範囲(度)
 */
func (this *findEventsOptions) GetLocation() (lat, lng, r float64) { return *this.lat, *this.lng, this.r }
 ...
 * @return bool
 */
func (this *findEventsOptions) IsLocationSet() bool { return this.lat != nil && this.lng != nil && this.r > 0.0 }
